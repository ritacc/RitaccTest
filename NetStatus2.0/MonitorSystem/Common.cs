...
namespace MonitorSystem
{
    ...
    {
        public static string _InitParm = null;
        public static string InitParm {
            get
            {
                if (_InitParm == null)
                {
                    ...
                    foreach (KeyValuePair<string, string> kv in Application.Current.Host.InitParams)
                    {
                        _InitParm = kv.Value;
                    }
                }
        ...
        public static string TopUrl()
        {
            string strTopUrl = Application.Current.Host.Source.ToString()
                    .Replace("/ClientBin/NetStatus.xap", "");
            return strTopUrl;
        }
