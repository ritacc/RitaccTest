    ...
    $.fn.makeAsyncUploader = function (options) {
        return this.each(function () {
            ...
            var defaults = {
                ...
                file_types_description: options.filedescription,
                debug: false,
                ...
                button_text: "<font face='Arial' size='13pt'>浏览</font>",
                ...
                upload_error_handler: function (file, code, msg) {
                    if (options.uploadErrorHandler) {
                        options.uploadErrorHandler(file, code, msg);
                    }
                    else {
                ...
                upload_start_handler: function (file) {
                    if (options.uploadStartHandler) {
                        options.uploadStartHandler();
                    }
                    showAjaxLoading();
                ...
                upload_success_handler: function (file, response) {
                    if (options.uploadSuccessHandler) {
                        options.uploadSuccessHandler(file, response);
                    }
                    else {
                ...
                upload_complete_handler: function () {
                    hideAjaxLoading();
                    if (options.uploadCompleteHandler)
                        options.uploadCompleteHandler();
            ...
            //    var settings = swfu.getSetting(); alert(settings.button_text_style); alert(settings.button_text);          
