...
namespace App.Framework.Web.MvcSiteMapProvider.Internal
{
    /// <summary>
        ...
        : VirtualPathProvider
    {
        ...
        private bool PathExists(string path)
        {
            if (path.Contains("__MVCSITEMAPPROVIDER") && !path.Contains(".."))
            {
                ...
                return assembly.GetManifestResourceStream("App.Framework.Web.Sitemap.Web.Html.DisplayTemplates." + resourceFileName) != null;
            }
            return false;
        }
