...
var Core = (function (c, d, h) {
    var b = document.domain; if (/.*\.caipiao\.xx\.com$/i.test(b) && b.indexOf("bbs") < 0) {
        try { document.domain = "caipiao.xx.com" } catch (f) { } 
    }
...
, checkAd: function () {
    ...
    if (/reg\.xx\.com/i.test(l) || /reg\.youdao\.com/i.test(l)) { l = "" }
    if (l && !/caipiao\.xx\.com$/.test(l) && !/cp\.xx\.com$/.test(l) && !this.is4050x && c.top == c.self) {
        i = function () {
...
, repaint: function () {
    ...
    var e = d(".scrollWrap"); e[0] && e.xScrollGrid(); this.is4050x || this.hideSysMessage || (c.top == c.self && /^caipiao\.xx\.com$/i.test(c.location.host) && this.loadCdnJS("js2/userCenter/userMessage.js"));
    delete this.init;
    delete this.myInit;
